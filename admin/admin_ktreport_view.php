...
$sql = "SELECT * FROM request WHERE request_id = '".$_GET['id']."'";
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <div class="tg2">
                ...
                <form>
                    <p style="font-size: 24px ; font-family:fonts;">- ความเชื่อโยงกับยุทธศาสตร์</p>
                    <?php if($kt[33]==1){?>
                ...
                <br>
                <form>
                    <p style="font-size: 24px ;font-family:fonts;">- การประเมินผลตามวัตถุประสงค์</p>
                    <?php if($kt[34]==1){?>
                    <span class="fa fa-check" style="font-size: 14px ;"></span><? } else {?>
                    <input type="checkbox" disabled> <?php } ?>
