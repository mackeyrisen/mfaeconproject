...
if(isset($_POST["export"]))
{
 //$sql = "SELECT * FROM request WHERE status BETWEEN'2' AND '10'";
  $sql ="SELECT * FROM request2
INNER JOIN member ON request2.organize = member.name 
...
งบรายจ่ายอื่น
โครงการส่งเสริมสินค้าและธุรกิจฮาลาลในต่างประเทศ</td></tr>  
                    <tr>  
                         <th>ภูมิภาค</th>  
                         <th>สอท./สกญ.</th>  
                         <th>ชื่อโครงการ</th>  
  ...
  header('Content-Disposition: attachment; filename=โครงการส่งเสริมสินค้าและธุรกิจฮาลาลในต่างประเทศ.xls');
  echo $output;
