            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="save_profile.php" method="post" class="form-horizontal">
                        ...
                        <p >ข้อมูลเจ้าหน้าที่ 2</p>
                        <div class="row form-group">
                            <div class="col col-md-3">ชื่อ</div>
                            <div class="col-12 col-md-9"><input type="text"  name="name2" class="form-control" value="<?=$result['u_name2'] ?>" ></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">นามสกุล</div>
                            <div class="col-12 col-md-9"><input type="text"  name="lastname2" class="form-control" value="<?=$result['u_lastname2'] ?>" ></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">VOIP</div>
                            <div class="col-12 col-md-9"><input type="text"  name="voip2" class="form-control" value="<?=$result['u_voip2'] ?>" ></div>
                        </div>
                        <hr>
                        <div class="row form-group">
