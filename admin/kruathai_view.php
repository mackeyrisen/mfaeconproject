...
$sql = "SELECT * FROM request WHERE request_id LIKE '".$id."'";
...
$sql3 = "SELECT * FROM `kruathai_backup` WHERE request_id LIKE '".$id."'";
            ...
            <div class="col-sm-6">
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <?php if($result3[0]==$id){?>
                        <a href="kruathai_view2.php?id=<?=$id?>&user=<?=$user?>">
                        <button class="btn btn-outline-primary"><i class="fa fa-file-text"></i> คำขอเดิม</button>
                        </a> <?php } ?>
                        <button class="btn btn-outline-primary" data-toggle="modal" data-target="#mediumModal"><i class="fa fa-pencil"></i> แก้ไขสถานะ</button>
                    </div>
                </div>
            </div>
