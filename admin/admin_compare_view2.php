...
$year1 = $id."_".$current[0]; 
$year2 = $id."_".($current[0]-1);
$year3 = $id."_".($current[0]-2);
if($type==1){
$sql  = "SELECT * FROM request WHERE request_id ='".$year1."'" ; 
$query = $conn->query($sql);
$result = $query->fetch_array();

$sql3  = "SELECT * FROM request WHERE request_id ='$year2'" ; 
$query3 = $conn->query($sql3);
$result3 = $query3->fetch_array();
}

elseif ($type==2) {
$sql  = "SELECT * FROM request2 WHERE request_id ='".$year1."'" ; 
$query = $conn->query($sql);
$result = $query->fetch_array();

$sql3  = "SELECT * FROM request2 WHERE request_id ='$year2'" ; 
$query3 = $conn->query($sql3);
$result3 = $query3->fetch_array();
}
            ...
            <div class="row">
                <div class="col-sm-12" >
                    <table class="table table-bordered" style="font-family:myFirstFont;font-size: 22px ;margin-left:1px">
                        <thead>
                            <th width="150px"></th>
                            <th width="444px"><?=$current[0]+544 ?></th>
                            <th><?=$current[0]+543 ?></th>
                        </thead>
                        <tr>
