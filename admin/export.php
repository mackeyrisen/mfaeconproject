...
WHERE status BETWEEN 2 AND 10 ORDER BY country.country_no,member.id";
 $query = $conn->query($sql);
  ...
  $output .= '
   ...
   <tr> <td align="center"><p>คำขอตั้งงบประมาณรายจ่ายประจำปีงบประมาณ พ.ศ. 2562 
งบรายจ่ายอื่น
โครงการส่งเสริมนโยบายครัวไทยสู่ครัวโลกในต่างประเทศ</p></td></tr>  
                    <tr> <th>ลำดับ</th> 
                         <th>ภูมิภาค</th>  
                         <th>สอท./สกญ.</th>  
                         <th>ชื่อโครงการ</th>  
  ...
  header('Content-Disposition: attachment; filename=โครงการครัวไทยสู่ครัวโลก.xls');
