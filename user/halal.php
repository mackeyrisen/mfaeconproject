...
$sql = "SELECT * FROM request2 WHERE request_id = '".$_SESSION['user']."_".$current[0]."'";
...
<body>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1 style="font-family: TH SarabunPSK;font-size: 24px;font-weight: bold;">ร่างคำขอโครงการส่งเสริมสินค้าและธุรกิจฮาลาลในต่างประเทศ</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="content mt-3">
            ...
            <form action="save_request2.php" method="POST">
            <div align="center" style="margin-top: 50px;font-family:myFirstFont;font-weight: bold;font-size: 24px;margin-left:75px;margin-right: 75px; ">
                ...
                งบรายจ่ายอื่น<br>
                โครงการส่งเสริมสินค้าและธุรกิจฮาลาลในต่างประเทศ<br>
                <input class="form-control" type="hidden" name="typepro" value="โครงการส่งเสริมสินค้าและธุรกิจฮาลาลในต่างประเทศ">
            ...
            <div style="font-family:myFirstFont;font-size: 20px ;margin-left:84px">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="hidden" name="activity" value="ยกระดับขีดความสามารถในการแข่งขันและความร่วมือทางเศรษฐกิจระหว่างประเทศ">ยกระดับขีดความสามารถในการแข่งขันและความร่วมือทางเศรษฐกิจระหว่างประเทศ</td>
                    </tr>
                    <tr>
                  ...
                  <!--  <tr>
                        ...
                        <td><input class="form-control" type="hidden" name="produce" value="ความสัมพันธ์ไทยกับประเทศต่าง ๆ ในกรอบทวิภาคี">ผความสัมพันธ์ไทยกับประเทศต่าง ๆ ในกรอบทวิภาคี</td>
                    </tr> -->
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="number" name="budget" value="<?=$result[4] ?>"></td>
                    </tr>
                </table>
            </div>
            <br>
                <div class="container" style="margin-left:30px;margin-right:0px">
                    ...
                    <p style="font-weight: bold;color: black">8.ผลคาดว่าที่จะได้รับ</p>
                    <div class="page-wrapper box-content" >
                        <textarea class="content8" name="recieve" value=""><?=$result[16] ?></textarea>
                    </div>
                    <p style="font-weight: bold;">9.ผลการดำเนินการในปีที่ผ่านมา(หากมี)</p>
                    <div class="page-wrapper box-content" >
