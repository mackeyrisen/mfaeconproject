 ...
 <style >
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1 style="font-family: fonts;font-size: 24px;font-weight: bold;">รายงานผลการเบิกจ่ายและการดำเนินโครงการ</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="content mt-3">
            ...
            <form action="save_ktreport.php" method="POST">
            ...
            <br>
                <div class="container" style="margin-left:30px;margin-right:0px">
                    ...
                    <div class="page-wrapper box-content" align="Left">
                        ...
                        <label for="strategy1" class="radio-inline"><input type="radio" name="E" value="1" id="strategy1" <?php if($kt_report[33]=="1"){echo "checked";}?> > การขยายดอกาศและช่องทางธุรกิจแกกลุ่มผู้ประกอบการ SME ด้านอุตสาหกรรมโดยเฉพาะผู้ผลิตและส่งออกวัตถุดิบเครื่องปรุงไทย สินค้าเกษตรและผลไม้ไทย รวมทั้งที่เป็นนวัตกรรมอาหาร</label> <br>
                        
                        <label for="strategy2" class="radio-inline"><input type="radio" name="E" value="2" id="strategy2" <?php if($kt_report[33]=="2"){echo "checked";}?>> การเพิ่มขีดความสามารถในการแข่งขันและยกระดับมาตรฐานของบุคลากรด้านอาหารไทย (พัฒนาฝีมือพ่อครัว/ แม่ครัวร้านอาหารไทยในต่างประเทศ)</label> <br>
                        
                        <label for="strategy3" class="radio-inline"><input type="radio" name="E" value="3" id="strategy3" <?php if($kt_report[33]=="3"){echo "checked";}?> >  การกระตุ้นความนิยมอาหารไทยในต่างประเทศอย่างยั่งยืนและสอดรับนโนบายการท่องเที่ยวเชิงอาหาร รวมทั้งการสร้างเครือข่าย ครม. ระหว่างหน่วยงานด้านอาหารของไทยกับ ตปท.</label> <br>
                        
                        <label for="strategy4" class="radio-inline"> <input type="radio" name="E" value="4" id="strategy4" <?php if($kt_report[33]=="4"){echo "checked";}?> > ส่งเสริมอัตลักษณ์อาหารไทย</label>
                    </div>
                    <hr>
